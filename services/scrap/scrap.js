...
async function scrapeTweets() {
    ...
    if (fs.existsSync("tweets_unvr_2022.json")) {
        const existing = JSON.parse(fs.readFileSync("tweets_unvr_2022.json", "utf-8"));
    ...
    fs.writeFileSync("tweets_unvr_2022.json", JSON.stringify(tweetArray, null, 2));
