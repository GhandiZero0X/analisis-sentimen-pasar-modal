...
async function scrapeTweets() {
    ...
    if (fs.existsSync("tweets_icbp.json")) {
        const existing = JSON.parse(fs.readFileSync("tweets_icbp.json", "utf-8"));
    ...
    fs.writeFileSync("tweets_icbp.json", JSON.stringify(tweetArray, null, 2));
